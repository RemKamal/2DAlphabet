...
if __name__ == '__main__':
	...
	parser.add_option('--input', dest='input', default = 'histInputs/hist_1DZqq-dataReRecoSpring165eff-3481-Gridv13-sigHinclusive-pt5006007008009001000_msd_newk_125.root',help='directory with data', metavar='idir')
